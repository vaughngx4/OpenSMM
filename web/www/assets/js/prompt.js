...
async function doPrompt(text, type, element, callback) {
    ...
    if (type == 'confirm' && callback != 'none') {
        ...
        console.error("prompt() of type 'confirm' requires a callback function as a 4th parameter.");
    } else if (type == 'notify') {
    ...
    document.getElementById('bgprompt').style.animation = "fadein 0.7s ease forwards";
    document.getElementById('prompt').style.animation = "fadein 0.7s ease forwards";
}
export function closePrompt() {
    document.getElementById('bgprompt').style.animation = "fadeout 0.7s ease forwards";
    document.getElementById('prompt').style.animation = "fadeout 0.7s ease forwards";
    setTimeout(function () {
